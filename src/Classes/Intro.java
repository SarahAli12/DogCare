...
public class Intro
{
    ...
    public static Image[] Adopt () throws Exception
    {
        ...
        Image[] beagle = {loadImage ("beagle_puppy.png"), loadImage ("beagle_teen.png"), loadImage ("beagle_adult.png"), loadImage ("beagle_old.png"), loadImage ("beagle_eating.png"), loadImage ("beagle_standing.png"), loadImage ("beagle_belly.png"), loadImage ("beagle_chew.png"), loadImage ("beagle_fetch.png"), loadImage ("beagle_bath.png") };
        Image[] golden = {loadImage ("golden_puppy.png"), loadImage ("golden_teen.png"), loadImage ("golden_adult.png"), loadImage ("golden_old.png"), loadImage ("golden_eating.png"), loadImage ("golden_standing.png"), loadImage ("golden_belly.png"), loadImage ("golden_chew.png"), loadImage ("golden_fetch.png"), loadImage ("golden_bath.png") };
        Image[] corgi = {loadImage ("corgi_puppy.png"), loadImage ("corgi_teen.png"), loadImage ("corgi_adult.png"), loadImage ("corgi_old.png"), loadImage ("corgi_eating.png"), loadImage ("corgi_standing.png"), loadImage ("corgi_belly.png"), loadImage ("corgi_chew.png"), loadImage ("corgi_fetch.png"), loadImage ("corgi_bath.png") };
